...
public final class ReportRenderer {
    ...
    // C1 controls, bidirectional overrides, and the other invisible format characters are legal in
    // Java identifiers and can reorder or split a terminal line just like an ANSI sequence.
