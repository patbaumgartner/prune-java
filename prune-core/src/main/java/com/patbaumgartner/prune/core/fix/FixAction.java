...
public record FixAction(AnalysisIssue issue, Path file, int startOffset, int endOffset, String original,
	...
	public FixAction {
		...
		if (original.length() != endOffset - startOffset) {
			throw new IllegalArgumentException(
					"original text does not cover the span " + startOffset + ".." + endOffset);
		}
	}
}
