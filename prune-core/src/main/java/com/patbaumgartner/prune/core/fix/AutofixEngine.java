...
public interface AutofixEngine {
    ...
    // Plans and applies in one step; the returned report lists only what still needs a human.
    default AnalysisReport fix(AnalysisReport report) {
        ...
        return new AnalysisReport(remaining, summary, report.conservativeMode());
    }
}
