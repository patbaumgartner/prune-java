...
// "path[:line[:column]]" with one-based positions; 0 means absent. Only trailing digit runs are
// positions, so "C:\src\A.java:12" keeps its drive letter, and a run longer than nine digits is
// part of the path because it cannot be a position.
