...
public final class MavenPomParser {
    ...
    private static final class Handler extends DefaultHandler {
        ...
        public void endElement(String uri, String localName, String qName) {
            ...
            } else if (current != null && depth == 4 && isPath("project", "dependencies", "dependency", path.peekLast())) {
        ...
        List<DeclaredDependency> resolved() {
            ...
            for (Pending dependency : pending) {
                ...
                dependencies.add(new DeclaredDependency(groupId, artifactId, dependency.scope, dependency.type,
                        dependency.classifier, buildFile, dependency.artifactLine, dependency.startLine, dependency.endLine));
            }
            return dependencies;
        }
