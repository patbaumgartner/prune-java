...
public final class TextSearch {
    ...
    // A whole-word match: the neighbours may not extend the identifier. Dots and dollar signs are
    // boundaries so "com.example.Foo" and "Outer$Inner" both count as mentioning their parts.
    ...
    // Adds every whole word of the text to the sink, using the same boundaries as containsWord.
