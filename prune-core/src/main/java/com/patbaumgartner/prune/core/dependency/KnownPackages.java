...
// Package roots of widely used libraries whose artifact names alone would be ambiguous evidence
// (every Apache Commons artifact shares "commons"). Only unambiguous, stable roots belong here.
final class KnownPackages {
    ...
    private static final Map<String, List<String>> ROOTS = Map.ofEntries(
            ...
            Map.entry("org.apache.httpcomponents.client5:httpclient5", List.of("org.apache.hc.client5", "org.apache.hc.core5")),
