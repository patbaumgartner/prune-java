...
class DiagnosticMapperTest {
    ...
    void mapsIssueFieldsOntoDiagnostic() {
        var issue = new AnalysisIssue(IssueType.UNUSED_METHOD, Severity.WARNING, "Foo#bar",
                "src/main/java/Foo.java", "Method bar is unused", false);
    ...
    void trailingLineAndColumnBecomeZeroBasedPosition() {
        var issue = new AnalysisIssue(IssueType.UNUSED_FIELD, Severity.INFO, "Foo#x",
    ...
    void lineOnlyLocationKeepsColumnZero() {
        var issue = new AnalysisIssue(IssueType.UNUSED_CLASS, Severity.ERROR, "Foo",
                "src/main/java/Foo.java:3", "unused", false);
        var report = new AnalysisReport(List.of(issue), "one", true);
    ...
    void groupsIssuesFromTheSameFileUnderOneUri() {
        var first = new AnalysisIssue(IssueType.UNUSED_METHOD, Severity.WARNING, "Foo#a",
                "src/main/java/Foo.java:1", "a", false);
        var second = new AnalysisIssue(IssueType.UNUSED_METHOD, Severity.WARNING, "Foo#b",
                "src/main/java/Foo.java:2", "b", false);
        var other = new AnalysisIssue(IssueType.UNUSED_DEPENDENCY, Severity.INFO, "org.example:lib",
                "pom.xml", "c", false);
